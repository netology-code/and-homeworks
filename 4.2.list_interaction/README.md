...
**Задание:**
В домашнем задании продолжим работать с приложением из задания 4.1.
...
3. Прочитать строку из `SharedPreferences` и заполнить поле класса с данными для списка на его основе по аналогии с методом `prepareContent()` из домашнего задания 4.1.
