# Домашнее задание к занятию 3.1 «Верстка графического интерфейса в Android. LinearLaout. RelativeLayout»

Необходимо выполнить и представить на проверку следующие задания:

1. [Интерфейс калькулятора](3.1.1/)

2. [Действия калькулятора](3.1.2/)
